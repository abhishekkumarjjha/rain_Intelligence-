...
const PRODUCT_PATTERNS = [
  ["heloc",         /\b(heloc|home equity|equity line|second mortgage)\b/i],
  ["mortgage",      /\b(mortgage|home loan|homebuyer|home buyer|refinanc|purchase loan|fha|va loan|usda|construction loan)\b/i],
  ["auto-loan",     /\b(auto|car|vehicle|motorcycle|rv|boat)\s*(loan|financ|refinanc)|auto[- ]loan/i],
  ["credit-card",   /\b(credit card|cash back card|rewards card|visa|mastercard)\b/i],
  ["personal-loan", /\b(personal loan|signature loan|unsecured loan|debt consolidat|line of credit)\b/i],
  ["cd",            /\b(cds?\b|certificates? of deposit|share certificates?|term deposits?)\b/i],
  ["money-market",  /\b(money market|mma\b)\b/i],
  ["savings",       /\b(savings|save |high[- ]yield|nest egg|christmas club)\b/i],
  ["checking",      /\b(checking|current account|debit)\b/i],
