...
/* How many creatives from ONE advertiser get read by the vision model.
   ...
   Nationals are capped separately and much lower — see NATIONAL_READ_CAP in
   national-tier.js. They list four thousand creatives, are excluded from every
   denominator, and exist only as a reference ceiling, so reading deeper into
   them buys nothing a finding can use. Spend the reads where the analysis is. */
