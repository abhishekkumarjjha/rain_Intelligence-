...
export const PROFILES = {
  ...
  "auto-loan": P({
    label: "Auto Loan",
    // down_payment carries "up to 100% financing", which is how a lender
    // competes when it is not competing on rate. Without it that ad reads as
    // "advertised auto loan, printed no figure" — which is the opposite of what
    // the creative says.
    metrics: ["apr", "term_months", "down_payment"],
    primaryRate: "apr",
    snapshot: ["apr", "term_months", "down_payment"],
    claims: {
  ...
  "personal-loan": P({
    label: "Personal Loan",
    metrics: ["apr", "term_months"],
    primaryRate: "apr",
    snapshot: ["apr", "term_months"],
    claims: {
