  ...
  if (client.hasCoverage) {
    for (const metric of profile.metrics) {
      ...
      push({
        ...
        detail: `Running in the same window. If these describe different products or an optional add-on, no action is needed — worth confirming before the next brief.`,
